...
Tip: What is a Palindrome number? A palindrome number is a number which when
 reversed is equal to the original number. For example: 121, 12321, and 1001 etc.
...
for example reverse = 0. PRIME TESTING
...
public class PalindromeNumber5 {
    public static void main(String[] args) {
        ...
        if (scanner.hasNextInt()) {
            ...
            System.out.println("Invalid input. Please enter a vaild number. ");
